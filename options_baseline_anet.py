...
parser.add_argument('--model-id', type=str, default="rskp_baseline_anet", help='model id for saving model')
# loading model
...
parser.add_argument('--dataset-name', default='Anet', help='dataset to train on')
parser.add_argument('--sample-segments-num', default=75, help='video number')
parser.add_argument('--segment-frames-num', default=16, help='video number')
parser.add_argument('--frames-per-sec', default=25, help='video number')
parser.add_argument('--test-upgrade-scale', default=20, help='video number')
parser.add_argument('--test-gt-file-path', default='./data/Anet/gt.json', help='video number')
# model settings
...
parser.add_argument('--class-num', type=int, default=200, help='number of classes (default: 20)')
...
# training paramaters
parser.add_argument('--batch-size', type=int, default=128, help='number of instances in a batch of data (default: 10)')
...
parser.add_argument('--propotion', default=8., help='weight of attention normalization loss')
parser.add_argument('--temperature', default=1.0, help='weight of attention normalization loss')
parser.add_argument('--weight', default=0.5, help='weight of attention normalization loss')
parser.add_argument('--o_weight', default=0.8, help='weight of attention normalization loss')
parser.add_argument('--m_weight', default=0.2, help='weight of attention normalization loss')
parser.add_argument('--action_cls_num', default=200, help='weight of attention normalization loss')
parser.add_argument('--cls_threshold', default=0.02, help='weight of attention normalization loss')
parser.add_argument('--nms_thresh', default=0.02, help='weight of attention normalization loss')
parser.add_argument('--test_upgrade_scale', default=20, help='weight of attention normalization loss')

parser.add_argument('--video_num', default=9032, help='weight of attention normalization loss')
parser.add_argument('--sample_num', default=2, help='weight of attention normalization loss')
parser.add_argument('--out_feat_num', default=2048, help='weight of attention normalization loss')
parser.add_argument('--momentum', default=0.99, help='weight of attention normalization loss')
