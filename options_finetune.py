...
parser.add_argument('--model-id', type=str, default="rskp_dist_linprog_tmp_2_rerun", help='model id for saving model')
# loading model
parser.add_argument('--pretrained',default=True, action='store_true', help='is pretrained model')
...
parser.add_argument('--load_ckpt_path', type=str, default='./ckpt/Thumos14reduced/rskp_baseline_pretraining', help='epoch of loaded model')
parser.add_argument('--load_dist_ckpt', type=list, default=[140,170])
parser.add_argument('--dist_epoch', type=list, default=[200,230,245,260,275,300])
# storing parameters
...
parser.add_argument('--changeLR_list', type=int, default=[245,260], help='change lr step')
parser.add_argument('--changeLR_value', type=int, default=[2.048e-5,5.12e-7,2.56e-7], help='change lr step')
...
parser.add_argument('--dist_loss_increase', default=1.05, help='weight of pseudo label supervision loss')
...
parser.add_argument('--dist_temperature_decay', type=list, default=[0.1,0.1,0.01,0.01,0.01,0.008])
parser.add_argument('--max_dist_weight', default=50., help='weight of pseudo label supervision loss')

parser.add_argument('--noise_rate', default=0.0, help='weight of attention normalization loss')
