...
from model.main_branch2 import WSTAL, random_walk, predictor_yololike
...
class Processor():
    def __init__(self, args):
        ...
        if self.args.pretrained and self.args.load_ckpt_path is not None and self.args.run_type !=1:
