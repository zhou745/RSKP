...
parser.add_argument('--model-id', type=str, default="constrained_cluster_selfdist_update", help='model id for saving model')
# parser.add_argument('--model-id', type=str, default="EM_RDW_Mem_add_constrainedcluster0.1", help='model id for saving model')
...
# parser.add_argument('--model-id', type=str, default="baseline", help='model id for saving model')
# loading model
...
parser.add_argument('--changeLR_list', type=int, default=[40,80,120,200], help='change lr step')
...
parser.add_argument('--threshhold', default=[0.85,0.85,0.8,0.8], help='weight of pseudo label supervision loss')
parser.add_argument('--match_loss', default=0., help='weight of pseudo label supervision loss')
parser.add_argument('--dist_loss', default=5.0, help='weight of pseudo label supervision loss')
parser.add_argument('--dist_loss_decay', default=5.0, help='weight of pseudo label supervision loss')
