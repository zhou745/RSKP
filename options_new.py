...
parser.add_argument('--model-id', type=str, default="rskp_dist_linprog_1.035", help='model id for saving model')
# loading model
...
parser.add_argument('--dist_epoch', type=list, default=[200,230,245,
                                                        260,275,300])
parser.add_argument('--dist_temperature_decay', type=list, default=[0.1,0.1,0.01,
                                                                    0.01,0.01,0.008])
