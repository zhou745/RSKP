...
parser.add_argument('--model-id', type=str, default="constrained_cluster_selfdist", help='model id for saving model')
...
parser.add_argument('--max-epoch', type=int, default=400, help='maximum iteration to train (default: 50000)')
